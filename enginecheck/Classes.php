...
class clsLocale {
  ...
  function LoadTranslation($filename = "") {
    ...
    $this->Messages["ccs_cannotseek"] = "Registro especificado no encontrado.";
    $this->Messages["ccs_captcha_controlvalidation"] = "El valor entrado no coincide con el valor de la imagen.";
    $this->Messages["ccs_charset"] = "windows-1252";
    $this->Messages["ccs_clear"] = "Limpiar";
    $this->Messages["ccs_customlinkfield"] = "Detalles";
    $this->Messages["ccs_customoperationerror_missingparameters"] = "Faltan uno o mas parametros para proceder a la actualizacion/eliminacion. La aplicación ha fallado.";
    $this->Messages["ccs_databasecommanderror"] = "Error de comando de base de datos.";
    ...
    $this->Messages["ccs_directoryformprefix"] = "Directorio";
    $this->Messages["ccs_directoryformsuffix"] = "Directorio";
    $this->Messages["ccs_filenotfound"] = "El archivo {0} especificado en {1} no se encontró.";
    $this->Messages["ccs_filesfoldernotfound"] = "Imposible transferir el archivo del campo {0} - la carpeta de destino no existe.";
    ...
    $this->Messages["ccs_gridformprefix"] = "";
    $this->Messages["ccs_gridformsuffix"] = "Lista de";
    $this->Messages["ccs_gridpagenumbererror"] = "Numero de pagina invalido";
    $this->Messages["ccs_gridpagesizeerror"] = "(CCS06) Tamaño de pagina invalido";
    $this->Messages["ccs_incorrectemailformat"] = "Email no valido en el campo {0}.";
    $this->Messages["ccs_incorrectformat"] = "El valor en el campo {0} no es valido. use el siguiente formato:: {1}.";
    ...
    $this->Messages["ccs_largefile"] = "El tamaño del archivo en el campo {0} es muy grande.";
    $this->Messages["ccs_last"] = "Final";
    $this->Messages["ccs_localeid"] = "es";
    $this->Messages["ccs_login"] = "Login";
    $this->Messages["ccs_login_autologin_caption"] = "Recordarme el password";
    ...
    $this->Messages["ccs_nextmonthhint"] = "Siguiente mes";
    $this->Messages["ccs_nextquarterhint"] = "Siguiente trimestre";
    $this->Messages["ccs_nextthreemonthshint"] = "Siguentes tres meses";
    $this->Messages["ccs_nextyearhint"] = "Siguiente año";
    $this->Messages["ccs_nocategories"] = "Categorias no encontradas";
    $this->Messages["ccs_norecords"] = "No hay registros";
    $this->Messages["ccs_of"] = "de";
    $this->Messages["ccs_operationerror"] = "No se puede llevar a cabo esta {0} operacion. Uno o mas parametros no han sido especificados.";
    $this->Messages["ccs_password"] = "Password";
    $this->Messages["ccs_previous"] = "Anterior";
    $this->Messages["ccs_prevmonthhint"] = "Mes anterior";
    $this->Messages["ccs_prevquarterhint"] = "Trimestre anterior";
    $this->Messages["ccs_prevthreemonthshint"] = "Tres meses anteriores";
    $this->Messages["ccs_prevyearhint"] = "Año anterior";
    ...
    $this->Messages["ccs_rememberlogin"] = "Recordar mi Login y Password";
    ...
    $this->Messages["ccs_reportprintlink"] = "Version imprimible";
    ...
    $this->Messages["ccs_requiredsmtpserver_or_dir"] = "Por favor, especifique el servidor SMTP o seleccionelo del directorio";
    $this->Messages["ccs_search"] = "Buscar";
    $this->Messages["ccs_searchformpostfix"] = "";
    $this->Messages["ccs_searchformprefix"] = "";
    ...
    $this->Messages["ccs_tempfoldernotfound"] = "Insuficientes permisos para transferir el archivo del campo {0} - el archivo temporal destino no existe.";
    $this->Messages["ccs_tempinsufficientpermissions"] = "Insuficientes permisos para transferir el archivo del campo {0} en la carpeta temporal.";
    ...
    $this->Messages["ccs_update"] = "Enviar";
    $this->Messages["ccs_uploadcomponenterror"] = "Ocurrió un error mientras se iniciaba la transferencia del componente.";
    $this->Messages["ccs_uploadcomponentnotfound"] = "%s transfiriendo componente \"\"%s\"\" no se encontró. Seleccione otro o instale el componente.";
    $this->Messages["ccs_uploadingerror"] = "Ocurrio un error al transferir el archivo del campo {0}. Descripción del error: {1}.";
    $this->Messages["ccs_uploadingtempfoldererror"] = "Ocurrio un error al cargar el ficheros especificado en {0} en la carpeta temporal. Descripcion del error: {1}.";
